...
public class Producto
{
    ...
    [Required, Column("precio", TypeName = "numeric(12,2)")] public decimal Precio { get; set; }
    [Required, Column("volumen", TypeName = "numeric(12,2)")] public decimal Volumen { get; set; } // toneladas

    [Column("ubicacion")] public string? Ubicacion { get; set; }
    [Column("descripcion")] public string? Descripcion { get; set; }
    [Column("fecha_publicacion")] public DateTime? FechaPublicacion { get; set; }
